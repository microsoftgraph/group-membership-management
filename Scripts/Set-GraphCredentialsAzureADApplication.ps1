...
(application permissions User.Read.All and GroupMember.ReadWrite.All) and write its credentials to a key vault in another tenant.
...
function Set-GraphCredentialsAzureADApplication {
	...
	$requiredResourceAccess.ResourceAccess = (Get-AzureADServicePrincipal -Filter "AppId eq '00000003-0000-0000-c000-000000000000'").AppRoles `
		| Where-Object { ($_.Value -eq "User.Read.All") -or ($_.Value -eq "GroupMember.ReadWrite.All") } `
