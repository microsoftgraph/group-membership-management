...
export const strings: IStrings = {
  ...
  addOwnerErrorMessage: "Estamos teniendo problemas para agregar GMM como propietario. Inténtalo de nuevo más tarde.",
  bannerMessage: "¿Necesitas ayuda? Haz click aquí para aprender más sobre como Membership Management funciona en tu organización.",
  okButton: "Aceptar",
  ...
  JobDetails: {
    ...
    descriptions: {
      ...
      increaseThreshold: "Número de usuarios que pueden ser añadidos al grupo destino, expresados como porcentaje del tamaño actual del grupo.",
      decreaseThreshold: "Número de usuarios que pueden ser removidos del grupo destino, expresados como porcentaje del tamaño actual del grupo.",
      thresholdViolations: "Número de ocasiones en las que se han excedido los límites."
    },
    MessageBar: {
