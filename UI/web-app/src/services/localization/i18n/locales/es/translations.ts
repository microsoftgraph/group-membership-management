  ...
  JobDetails: {
    ...
    Panel: {
      ...
      ThresholdExceededActionDialog: {
        title: 'Tomar acción',
        warningText: 'La última sincronización de {0} superó el umbral de alerta configurado y necesita su aprobación para continuar.',
        purgeDateText: 'Si no se toma ninguna acción antes del {0}, GMM purgará esta sincronización.',
        additionsDetailsText: 'GMM encontró {0} miembros para agregar, aumentando el tamaño del grupo en {1}% – por encima del umbral de aumento configurado de {2}%.',
        removalsDetailsText: 'GMM encontró {0} miembros para eliminar, disminuyendo el tamaño del grupo en {1}% – por encima del umbral de disminución configurado de {2}%.',
        applyChanges: 'Aplicar cambios',
        applyChangesDescription: 'Aprobar este cambio único y proceder con esta sincronización.',
        editRules: 'Editar reglas',
        editRulesDescription: 'Necesito revisar y actualizar las reglas de membresía.',
        editThreshold: 'Editar umbral de alerta',
        editThresholdDescription: 'Ajustar este umbral de alerta. Actualmente configurado en {0} de aumento y {1} de disminución.',
