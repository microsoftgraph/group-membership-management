...
export const strings: IStrings = {
  ...
  ManageMembership: {
    ...
    labels: {
      ...
      appIdNotOwnerWarning: 'Para administrar la membresía de este grupo, GMM debe ser propietario del grupo.{2}Agrega a {0} como propietario.{2}Una vez que hayas hecho eso, regresa y haz clic en: {1}',
      teamsServiceAccountNotOwnerWarning: 'GMM no es propietario de este canal de Teams. No podrá administrar la membresía de este canal hasta que lo agregues.{2}Agrega a {0} como propietario.{2}Una vez que hayas hecho eso, regresa y haz clic en: {1}',
