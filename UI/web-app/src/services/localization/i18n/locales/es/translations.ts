...
export const strings: IStrings = {
  ...
  JobDetails: {
    ...
    Panel: {
      ...
      endTimeColumnLabel: 'Hora de Finalización',
      durationColumnLabel: 'Duración (segundos)',
      statusColumnLabel: 'Estado',
      beforeSyncUserCountColumnLabel: 'Usuarios Pre-sincronización',
      usersAddedColumnLabel: 'Usuarios Agregados',
      usersRemovedColumnLabel: 'Usuarios Eliminados',
      afterSyncUserCountColumnLabel: 'Usuarios Post-sincronización',
