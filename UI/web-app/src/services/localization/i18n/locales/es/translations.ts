...
export const strings: IStrings = {
  ...
  HROnboarding: {
    ...
    andLogicDescription: "{0} incluye a las personas que satisfacen {1} las condiciones.{2}→ Example: Department es A {3} Location es X – solo las personas que están en el Department A y ubicadas en X serán incluídas.",
    orLogicDescription: "{0} incluye a las personas que satisfacen {1} de las condiciones.{2}→ Example: Department es A {3} Location es X – las personas que están en el Department A o ubicadas en X serán incluídas.",
    AND: "AND",
    OR: "OR",
    any: "alguna",
    allLowercase: "todas",
  ...
  ManageMembership: {
    ...
    labels: {
      ...
      step3description: 'Defina la fuente de la membresía para el destino. Puede agregar múltiples partes de origen para definir la fuente de la membresía, cada una con su propio criterio. GMM combinará todas las partes de origen para determinar la membresía del grupo destino.',
