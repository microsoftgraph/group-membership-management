...
export const strings: IStrings = {
  ...
  JobDetails: {
    ...
    Panel: {
      ...
      userCurrentlyInGroupMessage: 'Este usuario es actualmente parte de la membresía. Nota: El historial de sincronización solo se conserva durante 30 días.',
      userNotInGroupMessage: 'Este usuario no es actualmente parte de la membresía. Nota: El historial de sincronización solo se conserva durante 30 días.',
