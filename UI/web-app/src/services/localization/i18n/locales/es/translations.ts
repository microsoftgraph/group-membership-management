  ...
  JobDetails: {
    ...
    Panel: {
      ...
      ThresholdExceededActionDialog: {
        ...
        detailsText: 'GMM ha identificado {0} miembros para agregar, aumentando el tamaño del grupo en {1}% lo cual supera el umbral establecido de {2}%.',
        applyChanges: 'Aplicar cambios',
        applyChangesDescription: 'Proceder con esta sincronización aunque supere el límite. Esto puede aplicar un gran número de cambios.',
        editRules: 'Editar reglas',
        editRulesDescription: 'Actualizar la configuración de membresía para reducir el número de cambios antes de ejecutar la sincronización.',
        editThreshold: 'Editar umbral',
        editThresholdDescription: 'Ajustar el límite de porcentaje permitido para esta membresía.',
        pauseSync: 'Pausar sincronización',
        pauseSyncDescription: 'Detener esta sincronización hasta que revise y realice cambios.',
      },
      RunHistoryStatus: {
        idle: 'Completado',
        failed: 'Fallido',
