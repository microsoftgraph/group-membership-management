...
export const strings: IStrings = {
  ...
  HROnboarding: {
    ...
    attributeDescription: "Haga clic aquí para ver más información sobre cada atributo de filtro",
    attributeNameHeader: "Nombre del atributo",
    attributeDescriptionHeader: "Descripción del atributo",
