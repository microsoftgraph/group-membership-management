...
export const strings: IStrings = {
  ...
  JobDetails: {
    ...
    Panel: {
      ...
      ThresholdExceededActionDialog: {
        title: 'Take action',
        warningText: 'The latest sync for {0} exceeded the configured alert threshold and needs your approval to proceed.',
        purgeDateText: 'If no action is taken by {0}, GMM will purge this sync.',
        additionsDetailsText: 'GMM found {0} members to add, increasing group size by {1}% – above the configured increase threshold of {2}%.',
        removalsDetailsText: 'GMM found {0} members to remove, decreasing group size by {1}% – above the configured decrease threshold of {2}%.',
        applyChanges: 'Apply changes',
        applyChangesDescription: 'Approve this one-time change and proceed with this sync.',
        editRules: 'Edit rules',
        editRulesDescription: 'I need to review and update the membership rules.',
        editThreshold: 'Edit alert threshold',
        editThresholdDescription: 'Adjust this alert threshold. Currently set to {0} increase and {1} decrease.',
        pauseSync: 'Pause sync',
        pauseSyncDescription: 'Pause this sync and edit later.',
      },
  ...
  ManageMembership: {
    ...
    labels: {
      ...
      step3title: 'Step 3: Run Configuration',
      step3description: '',
