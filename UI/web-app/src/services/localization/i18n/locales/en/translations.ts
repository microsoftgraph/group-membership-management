...
export const strings: IStrings = {
  ...
  JobDetails: {
    ...
    Panel: {
      ...
      userCurrentlyInGroupMessage: 'This user is currently part of the membership. Note: Sync history is only retained for 30 days.',
      userNotInGroupMessage: 'This user is not currently part of the membership. Note: Sync history is only retained for 30 days.',
