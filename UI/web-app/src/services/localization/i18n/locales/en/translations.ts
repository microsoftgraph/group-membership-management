...
export const strings: IStrings = {
  ...
  ManageMembership: {
    ...
    labels: {
      ...
      appIdNotOwnerWarning: 'To manage this group\'s membership GMM must be an owner of the group.{2}Add {0} as an owner.{2}Once you have done that, come back and click: {1}',
      teamsServiceAccountNotOwnerWarning: "GMM is not the owner of this Teams Channel! It will not be able to manage membership for this channel until you add it.{2}Add {0} as an owner.{2}Once you have done that, come back and click: {1}",
