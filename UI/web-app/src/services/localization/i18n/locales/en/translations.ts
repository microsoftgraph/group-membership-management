...
export const strings: IStrings = {
  ...
  HROnboarding: {
    ...
    attributeDisabledErrorMessage: 'This attribute has been disabled. If you remove it and later want to add it back, you will need to reach out to admin for assistance.',    
  },
  Components: {
    AppHeader: {
