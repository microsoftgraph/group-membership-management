...
export const strings: IStrings = {
  ...
  HROnboarding: {
    ...
    equalToDescription: "Equal to",
    lessThanDescription: "Less than",
    lessThanOrEqualDescription: "Less than or equal to",
    greaterThanDescription: "Greater than",
    greaterThanOrEqualDescription: "Greater than or equal to",
    notEqualToDescription: "Not equal to",
    inDescription: "In",
    notInDescription: "Not in",
