...
export default defineConfig({
  ...
  webServer: {
    ...
    reuseExistingServer: useMockApi ? false : !process.env.CI,
    timeout: 120 * 1000,
    env: {
      ...process.env,
      REACT_APP_PLAYWRIGHT_MOCK_MODE: useMockApi ? 'true' : 'false',
      INTEGRATION_TEST_DOMAIN: process.env.INTEGRATION_TEST_DOMAIN || 'http://localhost:3000',
      INTEGRATION_TEST_EMAIL: process.env.INTEGRATION_TEST_EMAIL || 'playwright@contoso.com',
    },
  },
});
