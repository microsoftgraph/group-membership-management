...
module functionAppRBAC 'functionAppRBAC.bicep' = {
  name: 'functionAppsRBAC-SqlDataChecker'
  params: {
    functionName: 'SqlDataChecker'
...
module secretsTemplate 'keyVaultSecrets.bicep' = {
  name: 'secretsTemplate-SqlDataChecker'
  scope: resourceGroup(dataKeyVaultResourceGroup)
  params: {
    keyVaultName: dataKeyVaultName
    keyVaultParameters: [
      {
        name: 'sqlDataCheckerUrl'
...
module secureSecretsTemplate 'keyVaultSecretsSecure.bicep' = if(!featureFlags.skipListingFunctionAppKeys) {
  name: 'secureSecretsTemplate-SqlDataChecker'
  scope: resourceGroup(dataKeyVaultResourceGroup)
  params: {
    keyVaultName: dataKeyVaultName
    keyVaultSecrets: {
      secrets: [
        {
          name: 'sqlDataCheckerFunctionKey'
