...
var placeMembershipObtainerStorageAccountProd = resourceId(subscription().subscriptionId, dataKeyVaultResourceGroup, 'Microsoft.KeyVault/vaults/secrets', dataKeyVaultName, 'placeMembershipObtainerStorageAccountProd')
var placeMembershipObtainerStorageAccountStaging = resourceId(subscription().subscriptionId, dataKeyVaultResourceGroup, 'Microsoft.KeyVault/vaults/secrets', dataKeyVaultName, 'placeMembershipObtainerStorageAccountStaging')
...
var stagingSettings = {
  AzureWebJobsStorage: '@Microsoft.KeyVault(SecretUri=${reference(placeMembershipObtainerStorageAccountStaging, '2019-09-01').secretUriWithVersion})'
