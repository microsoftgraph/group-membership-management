...
namespace Services.Tests
{
    ...
    public class OrchestratorTests
    {
        ...
        public void Setup()
        {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync(nameof(LoggerFunction), It.IsAny<LoggerRequest>(), null))
                                        .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                                        {
                                            await CallLoggerFunctionAsync((LoggerRequest)request);
                                        });

            _durableOrchestrationContext.Setup(x => x.CallActivityAsync(nameof(JobStatusUpdaterFunction), It.IsAny<JobStatusUpdaterRequest>(), null))
                                        .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                                        {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync<List<SyncJob>>(nameof(GetJobsSegmentedFunction), It.IsAny<GetJobsSegmentedRequest>(), null))
                                        .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                                        {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync<List<Guid>>(nameof(JobsFilterFunction), It.IsAny<JobsFilterRequest>(), null))
                                        .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                                        {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync<string>(nameof(UsersSenderFunction), It.IsAny<UsersSenderRequest>(), null))
                                        .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                                        {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync<List<Guid>>(nameof(GetGroupOwnersFunction), It.IsAny<GetGroupOwnersRequest>(), null))
                            .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                            {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync(nameof(TelemetryTrackerFunction), It.IsAny<TelemetryTrackerRequest>(), null))
                                        .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                                        {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync(nameof(QueueMessageSenderFunction), It.IsAny<MembershipAggregatorHttpRequest>(), null))
                                        .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                                        {
            ...
            _durableOrchestrationContext.Setup(x => x.CallActivityAsync<bool>(nameof(SchemaValidatorFunction), It.IsAny<SchemaValidatorRequest>(), null))
                    .Callback<TaskName, object, TaskOptions>(async (name, request, options) =>
                    {
