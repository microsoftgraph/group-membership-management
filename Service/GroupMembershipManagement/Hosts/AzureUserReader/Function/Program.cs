        ...
        public static void Main(string[] args)
        {
            var host = new HostBuilder()
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    var functionName = nameof(AzureUserReader);
                    ...
                    services.AddSingleton<IStorageAccountSecret>(services => new StorageAccountSecret(CommonServices.GetValueOrThrowBase("storageAccountConnectionString")));
