...
namespace Services.Contracts
{
    public interface ISqlMembershipObtainerService
    {
        ...
        Task<(SyncStatus Status, string FilePath)> SendGroupMembershipAsync(List<GraphProfileInformation> profiles, SyncJob syncJob, Guid groupId, int currentPart, bool exclusionary, string adaptiveCardTemplateDirectory = "");
