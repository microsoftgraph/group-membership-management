...
{
    public class AzureMaintenance : IAzureMaintenance
    {
        ...
        public AzureMaintenance(string sourceTableName, string sourceConnectionString, string destinationConnectionString, string backupType, bool cleanupOnly, int deleteAfterDays)
        {
        ...
        public override bool Equals(object other)
        {
            ...
            var otherBackup = other as AzureMaintenance;
