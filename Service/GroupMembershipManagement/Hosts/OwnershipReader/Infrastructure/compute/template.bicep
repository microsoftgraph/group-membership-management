...
module servicePlanTemplate 'servicePlan.bicep' = {
  name: 'servicePlanTemplate-OwnershipReader'
  params: {
...
var stagingSettings = {
  WEBSITE_CONTENTSHARE: toLower('functionApp-OwnershipReader-staging')
  AzureFunctionsJobHost__extensions__durableTask__hubName: '${solutionAbbreviation}compute${environmentAbbreviation}OwnershipReaderStaging'
...
var productionSettings = {
  WEBSITE_CONTENTSHARE: toLower('functionApp-OwnershipReader')
  AzureFunctionsJobHost__extensions__durableTask__hubName: '${solutionAbbreviation}compute${environmentAbbreviation}OwnershipReader'
...
module functionAppTemplate_OwnershipReader 'functionApp.bicep' = {
  name: 'functionAppTemplate-OwnershipReader'
  params: {
    name: '${functionAppName}-OwnershipReader'
...
module functionAppSlotTemplate_OwnershipReader 'functionAppSlot.bicep' = {
  name: 'functionAppSlotTemplate-OwnershipReader'
  params: {
    name: '${functionAppName}-OwnershipReader/staging'
    kind: functionAppKind
    location: location
    servicePlanName: servicePlanName
    appSettings: commonSettings
  ...
  dependsOn: [
    functionAppTemplate_OwnershipReader
  ]
}

module dataKeyVaultPoliciesTemplate 'keyVaultAccessPolicy.bicep' = {
  name: 'dataKeyVaultPoliciesTemplate-OwnershipReader'
  scope: resourceGroup(dataKeyVaultResourceGroup)
  params: {
    name: dataKeyVaultName
    policies: [
      {
        objectId: functionAppTemplate_OwnershipReader.outputs.msi
        secrets: [
          'get'
          'list'
        ]
      ...
      {
        objectId: functionAppSlotTemplate_OwnershipReader.outputs.msi
        secrets: [
          'get'
          'list'
        ]
  ...
  dependsOn: [
    functionAppTemplate_OwnershipReader
    functionAppSlotTemplate_OwnershipReader
  ]
}

module prereqsKeyVaultPoliciesTemplate 'keyVaultAccessPolicy.bicep' = {
  name: 'prereqsKeyVaultPoliciesTemplate-OwnershipReader'
...
resource functionAppSettings 'Microsoft.Web/sites/config@2022-03-01' = {
  name: '${functionAppName}-OwnershipReader/appsettings'
  kind: 'string'
...
resource functionAppStagingSettings 'Microsoft.Web/sites/slots/config@2022-03-01' = {
  name: '${functionAppName}-OwnershipReader/staging/appsettings'
  kind: 'string'
