...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20260212000621_remove_syncjobhistory_fk_constraint")]
    partial class remove_syncjobhistory_fk_constraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3747d6fd-32e1-4375-91e3-0e3e9c577c47"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 0, 6, 19, 76, DateTimeKind.Utc).AddTicks(8454));
