...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20240709181547_threshold_notification")]
    partial class threshold_notification
    {
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dee1f40f-f1f1-4887-9d57-bd5d6cf7669c"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 9, 18, 15, 47, 251, DateTimeKind.Utc).AddTicks(4032));
