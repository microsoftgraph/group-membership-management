...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20250710213743_add_rescheduled_rescheduling_service_statuses")]
    partial class add_rescheduled_rescheduling_service_statuses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0942e5cc-5782-4f78-b534-aea517d4921f"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 10, 21, 37, 43, 456, DateTimeKind.Utc).AddTicks(316));
