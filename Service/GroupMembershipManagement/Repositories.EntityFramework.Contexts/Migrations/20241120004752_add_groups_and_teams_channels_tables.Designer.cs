...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20241120004752_add_groups_and_teams_channels_tables")]
    partial class add_groups_and_teams_channels_tables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e78c45a3-3610-47f0-9a3a-8d0f312a67fa"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 11, 20, 0, 47, 50, 141, DateTimeKind.Utc).AddTicks(9186));
