...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20241120002713_add_membership_types_table")]
    partial class add_membership_types_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0b998eb8-ca68-4373-8dc5-b5290b591370"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 11, 20, 0, 27, 12, 922, DateTimeKind.Utc).AddTicks(850));
