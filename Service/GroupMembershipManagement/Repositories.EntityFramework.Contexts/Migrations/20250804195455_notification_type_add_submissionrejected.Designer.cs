...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20250804195455_notification_type_add_submissionrejected")]
    partial class notification_type_add_submissionrejected
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a827a4e4-1da5-4ef4-b6e4-efd25b0a2866"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 4, 19, 54, 55, 271, DateTimeKind.Utc).AddTicks(8033));
