...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20260611194755_add_deferred_notifications_table")]
    partial class add_deferred_notifications_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a665165c-5730-4e20-bc6d-cd82aaec0f70"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 6, 11, 19, 47, 54, 948, DateTimeKind.Utc).AddTicks(10));
            ...
            modelBuilder.Entity("Models.AdfRun.AdfRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Models.DeferredNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("MessageExpiresAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("DeferredNotifications", (string)null);
                });
            ...
            modelBuilder.Entity("Models.NotificationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 15,
                            Disabled = false,
                            Name = "NestedGroupsFoundNotification"
                        });
                });
