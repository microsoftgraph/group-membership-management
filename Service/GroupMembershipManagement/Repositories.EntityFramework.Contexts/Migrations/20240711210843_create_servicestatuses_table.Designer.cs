...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20240711210843_create_servicestatuses_table")]
    partial class create_servicestatuses_table
    {
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2736fc08-37c0-43a6-b47c-dc9ab9dccc5f"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 11, 21, 8, 43, 699, DateTimeKind.Utc).AddTicks(5041));
