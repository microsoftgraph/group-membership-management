...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20251219211502_notification_type_add_nestedgroupsfound")]
    partial class notification_type_add_nestedgroupsfound
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3bef6e03-b6bd-4d2c-b0f8-54bf21b59efc"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 12, 19, 21, 15, 1, 688, DateTimeKind.Utc).AddTicks(1329));
