...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20240222000231_add_sql_membership_sources_table")]
    partial class add_sql_membership_sources_table
    {
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c7b6628a-54c9-4bdd-a451-1f6d6d1d75e6"),
                            Name = "SqlMembership"
                        });
                });
