...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20250211000410_add_business_justification_column")]
    partial class add_business_justification_column
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e06bd3cb-675e-4eef-b759-ee49b8f6cd1e"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 2, 11, 0, 4, 10, 253, DateTimeKind.Utc).AddTicks(6925));
