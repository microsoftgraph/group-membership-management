...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20251111183630_notification_type_add_submissionapproved")]
    partial class notification_type_add_submissionapproved
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("27ab4af9-fba6-406e-b8c8-7ecc3c37ad6e"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 10, 31, 18, 22, 25, 516, DateTimeKind.Utc).AddTicks(5071));
