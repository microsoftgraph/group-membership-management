...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20250303195224_add_changed_on_behalf_of_columns")]
    partial class add_changed_on_behalf_of_columns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ed6a552c-bf6d-4b0d-8b06-570423e515cc"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 3, 3, 19, 52, 23, 994, DateTimeKind.Utc).AddTicks(7393));
