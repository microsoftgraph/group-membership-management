...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20251125230525_add_nestedgroupsfound_status")]
    partial class add_nestedgroupsfound_status
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e2c95543-2cc9-4990-b76c-7eca27e66466"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 11, 25, 23, 5, 25, 302, DateTimeKind.Utc).AddTicks(4385));
