...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20250731203036_add_pendingconfiguration_status")]
    partial class add_pendingconfiguration_status
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4ecd876d-71eb-47bc-b7db-4362e5d5c451"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 20, 30, 35, 439, DateTimeKind.Utc).AddTicks(6811));
