...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20250804202701_add_titles_table")]
    partial class add_titles_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a3c759ae-c066-413e-ad4f-3703a9d01ad7"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 4, 20, 27, 0, 916, DateTimeKind.Utc).AddTicks(8059));
