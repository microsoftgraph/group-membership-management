...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20240410211421_add_removed_status")]
    partial class add_removed_status
    {
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("be953db1-da34-4591-a013-59ecc1ac8be5"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 10, 21, 14, 20, 700, DateTimeKind.Utc).AddTicks(2969));
