...
namespace Repositories.EntityFramework.Contexts.Migrations
{
    ...
    [Migration("20240612183023_notification_type")]
            ...
            modelBuilder.Entity("Entities.SqlMembershipSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("907ecc0b-60b9-4a9e-b536-c14993d64e46"),
                            Name = "SqlMembership"
                        });
                });
            ...
            modelBuilder.Entity("Entities.SyncJobChange", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 12, 18, 30, 23, 125, DateTimeKind.Utc).AddTicks(6706));
