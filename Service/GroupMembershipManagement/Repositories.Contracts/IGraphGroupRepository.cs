...
namespace Repositories.Contracts
{
    public interface IGraphGroupRepository
    {
        ...
        Task<(List<AzureADUser> usersToAdd, List<AzureADUser> usersToRemove, string nextPageUrl, string deltaUrl)> GetFirstDeltaLinkUsersPageAsync(string deltaLink, int numberOfPages);
